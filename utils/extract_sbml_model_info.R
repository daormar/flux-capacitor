...
## Write gene id's
write.table(allGenes(sbml_model), file=paste(o,"_gene_ids.csv",sep=""), sep=",", col.names=FALSE)

## Write reaction ids
write.table(sbml_model@react_id, file=paste(o,"_reaction_ids.csv",sep=""), sep=",", col.names=FALSE)

## Write gpr boolean vector
write.table(gpr(sbml_model)!="", file=paste(o,"_gpr_bool_vec.csv",sep=""), sep=",", col.names=FALSE)

## Write metabolite ids
write.table(sbml_model@met_id, file=paste(o,"_metabolite_ids.csv",sep=""), sep=",", col.names=FALSE)
...
write.table(sbml_model@lowbnd, file=paste(o,"_reaction_lowbnds.csv",sep=""), sep=",", col.names=FALSE)

## Write upper bounds for reactions
write.table(sbml_model@uppbnd, file=paste(o,"_reaction_uppbnds.csv",sep=""), sep=",", col.names=FALSE)
